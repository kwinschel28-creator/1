...
**Cash:** ~$4,014 (18.4%), after the ADT exit and the ORCL theme-cap trim. First real dry powder since 7/02. No cash ceiling is set; see [[Portfolio Strategy]]. **Total book:** ~$21,820.
...
- Breadth: 11 names above 2% vs the floor of 8 (four 8/10 exits, ADT among them). VSAT ~1.9%, IREN ~0.8% and QXO ~0.2% sit below the line. Correlated group: PATK + KMX are leveraged consumer-discretionary/rates bets, ~6.1% combined; NCLH and ADT left that group on 8/10. Not a named theme yet, watch it.
